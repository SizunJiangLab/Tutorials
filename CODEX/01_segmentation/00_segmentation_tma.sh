...
# Crop TMA
python /mnt/nfs/home/wenruiwu/projects/Tutorials/CODEX/01_segmentation/02_crop_tma.py \
    ${path_parameter}

# Segmentation
python /mnt/nfs/home/wenruiwu/projects/Tutorials/CODEX/01_segmentation/03_segment_mesmer.py \
    ${path_parameter} \
    ${tag}
