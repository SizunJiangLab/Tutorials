...
folder_names <- c(
  "Slide_202_Yury_IBD_v200",
  "Slide_436_Yury_IBD_v200",
  "Slide_527_Yury_IBD_v200",
  "Slide_583_202_S2b_S2b_S3b_Yury_IBD_v200",
  "Slide_583_Nb_Ib_S1b_Yury_IBD_v200",
  "Slide_610_Yury_IBD_v200",
  "spaceholder"
)
folder_names <- folder_names[folder_names != "spaceholder"]
storage_folders <- fs::path("/mnt/nfs/storage/cosmx/cosmx_backup/", folder_names, "AtoMx")

input_folders <- storage_folders
